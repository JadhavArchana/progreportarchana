...
namespace CATapp
{
	...
	public partial class CatAppDataClasses : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteUser(User instance);
		...
		public CatAppDataClasses(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
        //public CatAppDataClasses(System.Data.IDbConnection connection) : 
        //        base(connection, mappingSource)
        //{
        //    OnCreated();
        //}
		
		public CatAppDataClasses(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
        //public CatAppDataClasses(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
        //        base(connection, mappingSource)
        //{
        //    OnCreated();
        //}
	...
	public partial class Attempt_detail : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Attempt> _Attempt;
    ...
    partial void OnA_idChanging(System.Nullable<long> value);
    partial void OnA_idChanged();
    partial void OnO_idChanging(System.Nullable<long> value);
    partial void OnO_idChanged();
    partial void OnMark_flagChanging(System.Nullable<bool> value);
    partial void OnMark_flagChanged();
    ...
    partial void On_idChanged();
		...
		{
			this._Attempt = default(EntityRef<Attempt>);
			OnCreated();
		}
		...
		public System.Nullable<bool> Mark_flag
		{
			...
			set
			{
				...
				{
					this.OnMark_flagChanging(value);
					this.SendPropertyChanging();
					this._Mark_flag = value;
					this.SendPropertyChanged("Mark_flag");
					this.OnMark_flagChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK_attempts_007", Storage="_Attempt", ThisKey="A_id", OtherKey="_id", IsForeignKey=true)]
		public Attempt Attempt
		{
			get
			{
				return this._Attempt.Entity;
			}
			set
			{
				Attempt previousValue = this._Attempt.Entity;
				if (((previousValue != value) 
							|| (this._Attempt.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Attempt.Entity = null;
						previousValue.Attempt_details.Remove(this);
					}
					this._Attempt.Entity = value;
					if ((value != null))
					{
						value.Attempt_details.Add(this);
						this._A_id = value._id;
					}
					else
					{
						this._A_id = default(Nullable<long>);
					}
	...
	public partial class Attempt : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Attempt_detail> _Attempt_details;
    ...
    partial void OnTimedChanged();
		...
		public Attempt()
		{
			...
			this._Attempt_details = new EntitySet<Attempt_detail>(new Action<Attempt_detail>(this.attach_Attempt_details), new Action<Attempt_detail>(this.detach_Attempt_details));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK_008", Storage="_User", ThisKey="U_id", OtherKey="_id", IsForeignKey=true)]
		public User User
		{
			get
			{
			...
			set
			{
							...
							|| (this._User.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._U_id = value._id;
					}
					else
					{
						this._U_id = default(long);
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK_009", Storage="_Test", ThisKey="T_id", OtherKey="_id", IsForeignKey=true)]
		public Test Test
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK_attempts_007", Storage="_Attempt_details", ThisKey="_id", OtherKey="A_id", DeleteRule="NO ACTION")]
		public EntitySet<Attempt_detail> Attempt_details
		{
			get
			{
				return this._Attempt_details;
			}
			set
			{
				this._Attempt_details.Assign(value);
			}
		}
		...
		private void attach_Attempt_details(Attempt_detail entity)
		{
			this.SendPropertyChanging();
			entity.Attempt = this;
		}
		
		private void detach_Attempt_details(Attempt_detail entity)
		{
			this.SendPropertyChanging();
			entity.Attempt = null;
		}
    ...
    partial void OnNameChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK__question_categories__000000000000022C", Storage="_Question_categories", ThisKey="_id", OtherKey="C_id", DeleteRule="NO ACTION")]
    ...
    partial void OnCorrectChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK__options__000000000000023E", Storage="_Question", ThisKey="Q_id", OtherKey="_id", IsForeignKey=true)]
    ...
    partial void OnC_idChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK__question_categories__0000000000000228", Storage="_Question", ThisKey="Q_id", OtherKey="_id", IsForeignKey=true)]
		public Question Question
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK__question_categories__000000000000022C", Storage="_Category", ThisKey="C_id", OtherKey="_id", IsForeignKey=true)]
    ...
    partial void OnT_idChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK__options__000000000000023E", Storage="_Options", ThisKey="_id", OtherKey="Q_id", DeleteRule="NO ACTION")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK__question_categories__0000000000000228", Storage="_Question_categories", ThisKey="_id", OtherKey="Q_id", DeleteRule="NO ACTION")]
		public EntitySet<Question_category> Question_categories
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK__questions__000000000000021A", Storage="_Test", ThisKey="T_id", OtherKey="_id", IsForeignKey=true)]
		public Test Test
		{
			get
			{
    ...
    partial void OnAllowed_timeChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK__questions__000000000000021A", Storage="_Questions", ThisKey="_id", OtherKey="T_id", DeleteRule="NO ACTION")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK_009", Storage="_Attempts", ThisKey="_id", OtherKey="T_id", DeleteRule="NO ACTION")]
    ...
    partial void OnRegisteredChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="FK_008", Storage="_Attempts", ThisKey="_id", OtherKey="U_id", DeleteRule="NO ACTION")]
		public EntitySet<Attempt> Attempts
		{
			get
			{
